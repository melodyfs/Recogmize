...
class FruitsVC: UIViewController, UIImagePickerControllerDelegate {
    ...
    @IBAction func classifyPressed(_ sender: Any) {
...
extension FruitsVC: UINavigationControllerDelegate {
